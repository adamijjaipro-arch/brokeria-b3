...
const LoginPage: NextPage = () => {
  ...
  const input: React.CSSProperties = {
    ...
    borderRadius: '12px', fontSize: '14px', color: '#FFFFFF', background: '#1A1A1A',
  ...
  return (
    <>
      <PageSEO
        ...
        description="Connectez-vous à Alvio. Accès à vos signaux de trading algorithmique et stratégies personnalisées."
      ...
      <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', bottom: '-60px', left: '-60px', width: '250px', height: '250px', borderRadius: '50%', background: 'rgba(34,197,94,0.08)', filter: 'blur(50px)' }} />
          ...
          <div style={{ position: 'relative', padding: '16px', background: 'rgba(255,255,255,0.04)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.06)' }}>
            <p style={{ fontSize: '13px', color: '#9ca3af', margin: '0 0 8px', fontStyle: 'italic' }}>
              &ldquo;Alvio a transformé ma façon de trader. +40% de win rate.&rdquo;
            </p>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0A0A0A', padding: '40px' }}>
          <div style={{ width: '100%', maxWidth: '420px' }}>
            ...
            <div style={{ marginBottom: '28px' }}>
              <h2 style={{ fontSize: '26px', fontWeight: 700, color: '#FFFFFF', margin: '0 0 6px' }}>Connexion</h2>
              <p style={{ fontSize: '14px', color: '#888888', margin: 0 }}>
                Pas encore de compte ?{' '}
                <Link href="/register" style={{ color: '#3b82f6', fontWeight: 600, textDecoration: 'none' }}>Créer un compte</Link>
              </p>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
              ...
              <span style={{ fontSize: '13px', color: '#444444' }}>ou</span>
              <div style={{ flex: 1, height: '1px', background: '#1F1F1F' }} />
            </div>
                ...
                <div>
                  ...
                  <div style={{ position: 'relative' }}>
                    <input type={showPass ? 'text' : 'password'} placeholder="••••••••" value={password}
                      onChange={(e) => setPassword(e.target.value)} style={{ ...input, paddingRight: '44px' }} required />
              ...
              <div>
                {magicSent ? (
                  <div style={{ textAlign: 'center', padding: '24px 0' }}>
                    ...
                    <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#FFFFFF', margin: '0 0 8px' }}>Email envoyé !</h3>
                    <p style={{ fontSize: '14px', color: '#888888', margin: '0 0 16px' }}>
                      Vérifiez votre boîte mail à <strong style={{ color: '#FFFFFF' }}>{magicEmail}</strong>.<br />
...
const ErrorBox = ({ message }: { message: string }) => (
  <div style={{ background: 'rgba(239,68,68,0.08)', borderRadius: '10px', padding: '12px 14px', border: '1.5px solid rgba(239,68,68,0.20)', display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
    ...
    <div>
      ...
      <p style={{ fontSize: '13px', color: '#fca5a5', margin: '4px 0 0', lineHeight: '1.4' }}>{message}</p>
    </div>
  </div>
);
